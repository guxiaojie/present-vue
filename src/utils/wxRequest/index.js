...
const GetWeixintBasic = (url, params, options = {}, callback) => Base.doRequest(url, 'GET', params, options, callback)
const PostWeixintBasic = (url, params, options = {}, callback) => Base.doRequest(url, 'Post', params, options, callback)
